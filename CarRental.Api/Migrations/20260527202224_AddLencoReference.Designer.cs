...
namespace CarRental.Api.Migrations
{
    ...
    [Migration("20260527202224_AddLencoReference")]
    partial class AddLencoReference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRental.Api.Models.ZraInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ZraReferenceNumber")
                        .HasColumnType("text")
                        .HasColumnName("zra_reference_number");

                    b.Property<string>("ZraResponse")
                        .HasColumnType("jsonb")
                        .HasColumnName("zra_response");

                    b.HasKey("Id")
                        .HasName("zra_invoices_pkey");

                    b.HasIndex("BookingId");

                    b.HasIndex(new[] { "InvoiceNumber" }, "zra_invoices_invoice_number_key")
                        .IsUnique();

                    b.HasIndex(new[] { "ZraReferenceNumber" }, "zra_invoices_zra_reference_number_key")
                        .IsUnique();

                    b.ToTable("zra_invoices", (string)null);
                });
